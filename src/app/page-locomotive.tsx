  ...
  return (
    <LocomotiveScrollProvider>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-8" data-scroll data-scroll-speed="2">
          <h1 
      ...
      >
        ...
        <div className="relative z-10 text-white px-16" data-scroll data-scroll-speed="1">
      ...
      >
        ...
        <div className="relative z-10 text-white px-16 text-right ml-auto" data-scroll data-scroll-speed="1">
      ...
      <section 
        ...
        className="min-h-screen relative flex items-center justify-center bg-black"
      >
        <div className="relative z-10 text-white text-center" data-scroll data-scroll-speed="1">
      ...
      >
        ...
        <div className="relative z-10 text-white text-center px-16 max-w-4xl" data-scroll data-scroll-speed="1">
