      ...
      <div className="w-full">
          ...
          {[
            ...
            return (
              <div key={index} className="text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3">{amenity.title}</h3>
        ...
        >
          <div className="bg-gray-700 rounded-2xl p-3 sm:p-4 md:p-6">
            <h3 className="text-xl sm:text-2xl font-bold text-white text-center mb-4 sm:mb-5">Additional Features</h3>
