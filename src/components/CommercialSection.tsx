      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl md:text-2xl font-light text-gray-600 max-w-3xl mx-auto">
            Join our vibrant commercial community with premium retail and office spaces in the heart of Bhilai.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Be part of Bhilai&apos;s most exciting commercial development. Limited spaces available for lease and purchase.
          </p>
